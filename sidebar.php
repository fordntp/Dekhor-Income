    <!-- [ sidebar menu ] start -->
    <nav class="pcoded-navbar menu-light active-blue brand-blue">
        <div class="navbar-wrapper">
            ...
            </div><div class="slimScrollBar" style="background: rgba(0, 0, 0, 0.5); width: 5px; position: absolute; top: 19px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 316.127px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
        </div>
    </nav>
    <!-- [ sidebar menu ] end -->
